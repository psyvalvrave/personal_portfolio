...
export default function Index() {
    ...
    useLayoutEffect(() => {
        ...
        timeline.from(backgroundRef.current, { clipPath: 'inset(15%)' })
            ...
            <div className="flex justify-center relative mt-[35vh]">
                ...
                <div data-scroll data-scroll-speed="0.7" className="flex flex-col items-center text-center">
                    <div className="flex flex-col items-center space-y-4">
                        <TextGenerateEffect
                            words={`Hi. I am Zhecheng\nA Software Engineer`}
                            className="text-white text-4xl font-extrabold
                                    md:text-5xl lg:text-6xl"
                            filter={true}
                            duration={1}
                            highlightWord="Zhecheng"
                        />
                    </div>
                    <button 
                    onClick={scrollToDescription} 
                    className="group relative mt-4 h-12 w-40 overflow-hidden border-2 border-white text-white shadow-2xl transition-all duration-200 rounded-lg before:absolute before:inset-0 before:m-auto before:h-0 before:w-0 before:rounded-lg before:bg-indigo-800 before:opacity-0 before:duration-300 before:ease-out hover:text-white hover:shadow-indigo-600 hover:before:h-40 hover:before:w-40 hover:before:opacity-80 cursor-pointer">
